...
export default function VisualizeLogin() {
  ...
  return (
    <div
      style={{ textAlign: "center", backgroundColor: "pink", padding: "20px" }}
    >
      {/* Rubrik för inloggning */}
      <h1 style={{ textAlign: "center" }}>Inloggning</h1>
      {/* Beskrivning av komponenten */}
      <p>
        VisualizeLogin component, när inloggat visualiseras logga ut knappen
      </p>
...
// export default function VisualizeLogin() {
//   const [loggedInUser, setLoggedInUser] = useState(null);
//   const [selectedUser, setSelectedUser] = useState(null); // vald användare ur dropdownlista
//   const [password, setPassword] = useState("");
//   const [users, setUsers] = useState([]);

//   useEffect(() => { // hämtar hårdkodade användare
//     fetchUsers();
//   }, []);

//   const fetchUsers = () => {
//     // Hämta användare från API eller annan källa
//     const usersData = [
//       { username: "John Doe", password: "PPPP-4" },
//       { username: "Jane Smith", password: "XXXX-8" },
//       // Andra användare här...
//     ];
//     setUsers(usersData);
//   };
...
//   const handleLogin = () => {
//     // Hitta användaren med det valda användarnamnet sparas ii user
//     const user = users.find((user) => user.username === selectedUser);
//     if (user) {
//       // Kontrollera att lösenordet matchar med användare
//       if (user.password === password) {
//         setLoggedInUser(user.username);
//       } else {
//         alert("Fel lösenord!"); //FEL LÖSEN
//       }
//     } else {
//       alert("Användaren hittades inte!"); // Hittar ej anvcändare
//     }
//   };

//   const handleLogout = () => { // Hantera logg ut, nollställer
//     setLoggedInUser(null);
